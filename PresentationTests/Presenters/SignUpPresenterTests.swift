...
class SignUpPresenterTests: XCTestCase {
    ...
    func test_signUp_should_show_error_message_if_password_confirmation_not_match() {
        let alertViewSpy = AlertViewSpy()
        let sut = makeSut(alertView: alertViewSpy)
        let signUpViewModel = SignUpViewModel(name: "any_name", email: "any_mail@mail.com", password: "any_password", passwordConfirmation: "wrong_password")
        sut.signUp(viewModel: signUpViewModel)
    ...
    func test_signUp_should_show_error_message_if_invalid_email_is_provided() {
        ...
        let signUpViewModel = SignUpViewModel(name: "any_name", email: "invalid_mail@mail.com", password: "any_password", passwordConfirmation: "any_password")
